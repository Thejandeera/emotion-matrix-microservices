...
This document outlines the standard mathematical formula used by the **Emotion Matrix** platform to compute the overall **Weighted Sentiment Score** ($S_{\text{final}}$) displayed in the real-time Live Monitor dashboard.
...
2. **Detected Keyword Impact Weight** ($w_i \ge 1.0$) configured via the Supervisor Dashboard.
